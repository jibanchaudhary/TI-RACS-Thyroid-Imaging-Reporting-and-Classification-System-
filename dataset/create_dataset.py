...
from dataset.dataset_conversion import build_train_transforms, build_val_transforms, parse_xml_case, polygon_to_mask, crop_nodule
...
class ThyroidDataset(Dataset):
    def __init__(
        ...
        assert backbone in BACKBONE_SIZE, \
            f"backbone must be one of {list(BACKBONE_SIZE.keys())}"
        ...
        print(f"[ThyroidDataset] {split:5s} | {len(self.cases):4d} cases | "
